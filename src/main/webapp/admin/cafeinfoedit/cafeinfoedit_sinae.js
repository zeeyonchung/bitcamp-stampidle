...
$('#cafe-photo').fileupload({
 ...
 function add_cafeImg(){
     ...
     $( "#field-cafeimg > div:last-child .photoPath" ).attr("id", "cafe-photo-path" + $( "#field-cafeimg > div").length);
